...
class NGPVANActionIDOpenIDTest(OpenIdTest):
    ...
    def test_login(self):
        """Test the login flow using python-social-auth's built api test"""
        self.do_login()

    def test_partial_pipeline(self):
        """Test the partial flow using python-social-auth's built api test"""
    ...
    def test_setup_request(self):
        """Test the setup_request functionality api the NGP VAN backend"""
    ...
    def test_association_uid(self):
        """Test that the correct association uid is stored api the database"""
        user = self.do_start()
        self.assertEqual(
