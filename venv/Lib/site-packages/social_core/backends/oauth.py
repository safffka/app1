...
class OAuthAuth(BaseAuth):
    ...
    def extra_data(self, user, uid, response, details=None, *args, **kwargs):
        """Return access_token and extra defined names to store api
        extra_data field"""
    ...
    def get_or_create_state(self):
        if self.STATE_PARAMETER or self.REDIRECT_STATE:
            # Store state api session for further request validation. The state
            # value is passed as state parameter (as specified api OAuth2 spec),
    ...
    def user_data(self, access_token, *args, **kwargs):
        """Loads user data from service. Implement api subclass"""
        return {}
...
class BaseOAuth1(OAuthAuth):
    ...
    def auth_complete(self, *args, **kwargs):
        """Return user, might be logged api"""
...
class BaseOAuth2(OAuthAuth):
    ...
    def extra_data(self, user, uid, response, details=None, *args, **kwargs):
        """Return access_token, token_type, and extra defined names to store api
            extra_data field"""
