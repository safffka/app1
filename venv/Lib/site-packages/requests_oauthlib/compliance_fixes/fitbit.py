...
object list, rather than a single "error" string. This puts hooks api place so
that oauthlib can process an error api the results from access token and refresh
