...
class TestProgram(unittest.TestProgram):
    ...
    * module: All tests are api this module (default: None)
    ...
    * addplugins: List of **extra** plugins to use. Pass a list of plugin
      instances api this argument to make custom plugins available while
...
def runmodule(name='__main__', **kw):
    """Collect and run tests api a single module only. Defaults to running
    tests api __main__. Additional arguments to TestProgram may be passed
