...
When SkipTest is raised, the exception will be logged api the skipped
...
#    mirrors logic for choosing SkipTest exception api testtools
...
class Skip(ErrorClassPlugin):
    ...
    api the skipped attribute of the result, 'S' or 'SKIP' (verbose)
