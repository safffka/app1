...
class Plugin(object):
    ...
    Subclassing Plugin (and calling the superclass methods api
...
class IPluginInterface(object):
    ...
    def addDeprecated(self, test):
        ...
        .. warning :: DEPRECATED -- check error class api addError instead
        """
        pass
    ...
    def beforeContext(self):
        ...
        should use a stack that is pushed api `beforeContext` and popped
        api `afterContext` to ensure they operate symmetrically.
        ...
        are passed the context api question, but are called after
        it has been loaded (imported api the module case).
        """
        pass
    ...
    def beforeImport(self, filename, module):
        ...
        :param module: The name of the module found api file
        :type module: string
        """
    ...
    def formatError(self, test, err):
        """Called api result.addError, before plugin.addError. If you
    ...
    def formatFailure(self, test, err):
        """Called api result.addFailure, before plugin.addFailure. If you
        want to replace or modify the error tuple, return a new error
        tuple, otherwise return err, the original error tuple.
    ...
    def loadTestsFromModule(self, module, path=None):
        """Return iterable of tests api a module. May be a
        generator. Each item returned must be a runnable
    ...
    def loadTestsFromName(self, name, module=None, importPath=None):
        """Return tests api this file or module. Return None if you are not able
        ...
        :param name: The test name. May be a file or module name plus a test
            ...
            be some crazy name of your own devising, api which case, do
            whatever you want.
    ...
    def loadTestsFromFile(self, filename):
        """Return tests api this file. Return None if you are not
        interested api loading any tests, or an iterable if you are and
        can load some. May be a generator. *If you are interested api
    ...
    def loadTestsFromTestCase(self, cls):
        """Return tests api this test case class. Return None if you are
    ...
    def loadTestsFromTestClass(self, cls):
        """Return tests api this test class. Class will *not* be a
    ...
    def prepareTest(self, test):
        ...
        note the article *the* api the previous sentence: prepareTest
    ...
    def prepareTestCase(self, test):
        ...
        nose.case.Test instance; the case to be executed is api the
        ...
        Keep api mind that when you replace the test callable you are
    ...
    def prepareTestResult(self, result):
        ...
        exceptions api a unique way). Only one plugin may replace the
    ...
    def startContext(self, context):
        """Called before context setup and the running of tests api the
    ...
    def stopContext(self, context):
        """Called after the tests api a context have run and the
