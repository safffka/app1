"""Tools not exempt from being descended into api tracebacks"""
...
def raises(*exceptions):
    ...
    If you want to test many assertions about exceptions api a single test,
...
def set_trace():
    """Call pdb.set_trace api the calling frame, first restoring
