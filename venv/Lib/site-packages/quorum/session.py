...
class RedisSessionInterface(flask.sessions.SessionInterface):
    ...
    contained api the session (used on top of the class) """
    ...
    def open_session(self, app, request):
        ...
        # application cookie (or from parameters) api case
        ...
        # tries to retrieve the session value from redis api
        ...
        # session identifier, but not found api data source (redis)
