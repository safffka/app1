...
def code_challenge_method_s256(verifier, challenge):
    ...
    below.  Similar code could be used api other languages.
...
class AuthorizationCodeGrant(GrantTypeBase):
    ...
    The flow illustrated api Figure 3 includes the following steps:
    ...
    (C)  Assuming the resource owner grants access, the authorization
         ...
         redirection URI provided earlier (api the request or during
    ...
    (D)  The client requests an access token from the authorization
         ...
         received api the previous step.  When making the request, the
    ...
    (E)  The authorization server authenticates the client, validates the
         ...
         received matches the URI used to redirect the client api
    ...
    Exchange (PKCE, pronounced "pixy") is implemented api the current oauthlib
    implementation.
    ...
    def create_authorization_response(self, request, token_handler):
        ...
        response_type
                ...
                essentially test that "code" appears api the response_type.
        client_id
                REQUIRED.  The client identifier as described api `Section 2.2`_.
        redirect_uri
                OPTIONAL.  As described api `Section 3.1.2`_.
        scope
        ...
        A few examples::
            ...
            >>> request.scopes = ['authorized', 'api', 'some', 'form']
            ...
            Traceback (most recent call last):
                ...
                File "oauthlib/oauth2/rfc6749/grant_types.py", line 515, api create_authorization_response
                    >>> grant.create_authorization_response(request, token)
                File "oauthlib/oauth2/rfc6749/grant_types.py", line 591, api validate_authorization_request
    ...
    def validate_authorization_request(self, request):
        ...
        Normal errors can safely be included api the redirection URI and
        ...
        # REQUIRED. The client identifier as described api Section 2.2.
        ...
        # OPTIONAL. As described api Section 3.1.2.
        ...
        if request.code_challenge is not None:
            ...
            # OPTIONAL, defaults to "plain" if not present api the request.
    ...
    def validate_token_request(self, request):
        ...
        if self.request_validator.client_authentication_required(request):
            ...
            # authorization server as described api Section 3.2.1.
            # https://tools.ietf.org/html/rfc6749#section-3.2.1
            log.debug('Client authentication failed, %r.', request)
            raise errors.InvalidClientError(request=request)
        ...
        # REQUIRED, if the "redirect_uri" parameter was included api the
        # authorization request as described api Section 4.1.1, and their
