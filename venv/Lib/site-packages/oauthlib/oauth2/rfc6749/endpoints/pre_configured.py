...
class Server(AuthorizationEndpoint, IntrospectEndpoint, TokenEndpoint,
    ...
    """An all-api-one endpoint featuring all four major grant types."""

    def __init__(self, request_validator, token_expires_in=None,
                 token_generator=None, refresh_token_generator=None,
                 *args, **kwargs):
        """Construct a new all-grants-api-one server.

        :param request_validator: An implementation of
                                  oauthlib.oauth2.RequestValidator.
        :param token_expires_in: An int or a function to generate a token
                                 expiration offset (api seconds) given a
...
class WebApplicationServer(AuthorizationEndpoint, IntrospectEndpoint, TokenEndpoint,
    ...
    """An all-api-one endpoint featuring Authorization code grant and Bearer tokens."""
...
class MobileApplicationServer(AuthorizationEndpoint, IntrospectEndpoint,
    ...
    """An all-api-one endpoint featuring Implicit code grant and Bearer tokens."""
...
class LegacyApplicationServer(TokenEndpoint, IntrospectEndpoint,
    ...
    """An all-api-one endpoint featuring Resource Owner Password Credentials grant and Bearer tokens."""
...
class BackendApplicationServer(TokenEndpoint, IntrospectEndpoint,
    ...
    """An all-api-one endpoint featuring Client Credentials grant and Bearer tokens."""
