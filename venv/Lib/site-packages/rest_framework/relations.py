...
class Hyperlink(str):
    ...
    api some contexts, or render as a plain URL api others.
    """
    ...
    def name(self):
        ...
        # as api some cases calling __str__ on a model instances *might*
...
class PKOnlyObject:
    ...
    api order to keep the same interface as a regular model instance.
    """
...
class RelatedField(Field):
    ...
    def __new__(cls, *args, **kwargs):
        # We override this method api order to automagically create
...
class HyperlinkedRelatedField(RelatedField):
    ...
    def __init__(self, view_name=None, **kwargs):
        ...
        # We include this simply for dependency injection api tests.
    ...
    def to_representation(self, value):
        assert 'request' in self.context, (
            "`%s` requires the request api the serializer"
        ...
        try:
            ...
            msg = (
                ...
                'model api your API, or incorrectly configured the '
            ...
            if value in ('', None):
                ...
                msg += (
                    ...
                    "entries api your URL conf." % value_string
                )
...
class HyperlinkedIdentityField(HyperlinkedRelatedField):
    ...
    This is api contrast to `HyperlinkedRelatedField` which represents the
