...
class AcceptHeaderVersioning(BaseVersioning):
    ...
    """
    invalid_version_message = _('Invalid version api "Accept" header.')
...
class URLPathVersioning(BaseVersioning):
    ...
    The difference is api the backend - this implementation uses
    ...
    """
    invalid_version_message = _('Invalid version api URL path.')
...
class NamespaceVersioning(BaseVersioning):
    ...
    Accept: application/json
    """
    invalid_version_message = _('Invalid version api URL path. Does not match any version namespace.')
...
class HostNameVersioning(BaseVersioning):
    ...
    invalid_version_message = _('Invalid version api hostname.')
...
class QueryParameterVersioning(BaseVersioning):
    ...
    Accept: application/json
    """
    invalid_version_message = _('Invalid version api query parameter.')
