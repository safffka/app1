...
class SearchFilter(BaseFilterBackend):
    ...
    def filter_queryset(self, request, queryset, view):
        ...
        if self.must_call_distinct(queryset, search_fields):
            ...
            # call queryset.distinct() api order to avoid duplicate items
            # api the resulting queryset.
...
class OrderingFilter(BaseFilterBackend):
    ...
    def get_ordering(self, request, queryset, view):
        ...
        specifying an `ORDERING_PARAM` value api the API settings.
        """
    ...
    def get_default_valid_fields(self, queryset, view, context={}):
        ...
        model_property_names = [
            # 'pk' is a property added api Django's Model class, however it is valid for ordering.
