...
class JSONRenderer(BaseRenderer):
    ...
    def get_indent(self, accepted_media_type, renderer_context):
        ...
        # If 'indent' is provided api the context, then pretty print the result.
...
class TemplateHTMLRenderer(BaseRenderer):
    ...
    The template name is determined by (api order of preference):
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    def get_rendered_html_form(self, data, view, method, request):
        ...
        # HTTP method as was used api the request then use the existing
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        ...
        # the normal deletion response code api the output)
        response = renderer_context['response']
...
class AdminRenderer(BrowsableAPIRenderer):
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        ...
        # Creation and deletion should use redirects api the admin style.
        ...
        if hasattr(data, 'items'):
            for key, value in data.items():
                assert not isinstance(value, dict), (
                    ...
                    "You may want to consider using format='json' api this "
                    "test case." % key
                )
