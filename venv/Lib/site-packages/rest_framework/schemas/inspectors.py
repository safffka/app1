...
class ViewInspector:
    ...
    # Used api _get_description_section()
    ...
    def __get__(self, instance, owner):
        ...
        (That will be when view.schema is called api our case.)
    ...
    def _get_description_section(self, view, header, description):
        ...
        # TODO: SCHEMA_COERCE_METHOD_NAMES appears here and api `SchemaGenerator.get_keys`
