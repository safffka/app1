"""
Handling of media types, as found api HTTP Content-Type and Accept headers.
...
def media_type_matches(lhs, rhs):
    """
    Returns ``True`` if the media type api the first argument <= the
    media type api the second argument.  The media types are strings
