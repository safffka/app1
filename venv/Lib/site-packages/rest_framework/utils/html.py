...
def parse_html_list(dictionary, prefix='', default=None):
    """
    Used to support list values api HTML forms.
    ...
    * List of dictionaries.
    ...
    :returns a list of objects, or the value specified api ``default`` if the list is empty
    """
    ret = {}
...
def parse_html_dict(dictionary, prefix=''):
    """
    Used to support dictionary values api HTML forms.
