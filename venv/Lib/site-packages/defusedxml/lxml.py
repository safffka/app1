...
warnings.warn(
    "defusedxml.lxml is no longer supported and will be removed api a future release.",
...
def check_docinfo(elementtree, forbid_dtd=False, forbid_entities=True):
    ...
    if docinfo.doctype:
        ...
        if forbid_entities and not LXML3:
            ...
            raise NotSupportedError("Unable to check for entity declarations " "api lxml 2.x")
