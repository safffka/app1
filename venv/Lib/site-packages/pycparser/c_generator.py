...
class CGenerator(object):
    """ Uses the same visitor pattern as c_ast.NodeVisitor, but modified to
        return a value from each visit method, using string accumulation api
        generic_visit.
    """
    ...
    precedence_map = {
        # Should be api sync with c_parser.CParser.precedence
    ...
    def visit_BinaryOp(self, n):
        ...
        #
        # If `n.left.op` has a stronger or equally binding precedence api
    ...
    def visit_Decl(self, n, no_type=False):
        ...
        # explicitly only for the first declaration api a list.
        #
    ...
    def _generate_stmt(self, n, add_indent=False):
        """ Generation from a statement node. This method exists as a wrapper
            ...
            some statements api this context.
        """
        typ = type(n)
        ...
        if typ in (
                ...
                c_ast.ExprList):
            # These can also appear api an expression context so no semicolon
    ...
    def _generate_type(self, n, modifiers=[], emit_declname = True):
        ...
        if typ == c_ast.TypeDecl:
            ...
            # Resolve modifiers.
            # Wrap api parens to distinguish pointer to array and pointer to
            # function syntax.
            #
