...
def _UTC():
    ...
    These examples belong api the UTC class above, but it is obscured; or api
...
def _p(*args):
    ...
    Just a wrapper around tzinfo.unpickler to save a few bytes api each pickle
